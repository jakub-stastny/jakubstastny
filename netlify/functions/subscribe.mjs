...
var headers = cherry_core.vector("Content-Type", "application/json", "X-MailerLite-ApiKey", api_key);
...
export { api_key, handler, dbg, axios, group_id, parse_json, endpoint, response, handle_post, subscribe, headers }
