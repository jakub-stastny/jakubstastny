...
const spiritual_guidance3 = item_link.call(null, cherry_core.keyword("services-guidance").call(null, router));
const astro_reading4 = item_link.call(null, cherry_core.keyword("services-reading").call(null, router));
const remote_healing5 = item_link.call(null, cherry_core.keyword("services-healing").call(null, router));
