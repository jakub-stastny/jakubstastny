...
import { tag, no_self_referring_link, get_BANG_ } from 'helpers';
import { router } from 'router';
var item_link = (function (router_entry) {
return no_self_referring_link.call(null, get_BANG_.call(null, router_entry, cherry_core.keyword("title")), get_BANG_.call(null, router_entry, cherry_core.keyword("path")));
});
...
const main1 = item_link.call(null, get_BANG_.call(null, router, cherry_core.keyword("index")));
const about2 = item_link.call(null, get_BANG_.call(null, router, cherry_core.keyword("about")));
const spiritual_guidance3 = item_link.call(null, get_BANG_.call(null, router, cherry_core.keyword("services-guidance")));
const astro_reading4 = item_link.call(null, get_BANG_.call(null, router, cherry_core.keyword("services-reading")));
const remote_healing5 = item_link.call(null, get_BANG_.call(null, router, cherry_core.keyword("services-healing")));
const services6 = cherry_core.vector(item_link.call(null, get_BANG_.call(null, router, cherry_core.keyword("services"))), tag.call(null, cherry_core.keyword("ul"), cherry_core.vector(tag.call(null, cherry_core.keyword("li"), spiritual_guidance3), tag.call(null, cherry_core.keyword("li"), astro_reading4), tag.call(null, cherry_core.keyword("li"), remote_healing5))));
const contact7 = item_link.call(null, get_BANG_.call(null, router, cherry_core.keyword("contact")));
